...
| -u, --usernames        | n/a                                                                                                   | The name of the json file mapping the existing github users to their new usernames in the export. See github_username_map.json file in the test folder for formatting. |
